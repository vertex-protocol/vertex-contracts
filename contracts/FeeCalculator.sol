...
contract FeeCalculator is Initializable, IFeeCalculator, Version {
    ...
    function getFeeFractionX18(
        ...
        require(productId != 0 && productId <= 62, "invalid productId");
        ...
        if (userFeeRates.isNonDefault == 0) {
            ...
            if (productId % 2 == 1) {
                if (
                    ...
                    // btc-spot, eth-spot, arb-spot, vrtx-spot
                ...
                if (productId == 32 || productId == 42) {
                    ...
                    // arb-perp, bnb-perp, xrp-perp, sol-perp, matic-perp, sui-perp, op-perp, apt-perp,
                    // ltc-perp, bch-perp, comp-perp, mkr-perp, mpepe-perp, doge-perp, link-perp, dydx-perp,
                    // crv-perp, vrtx-spot, tia-perp, pyth-perp, mbonk-perp, jto-perp, avax-perp, inj-perp,
                    // snx-perp, ada-perp, imx-perp, meme-perp
                    userFeeRates = FeeRates(0, 200_000_000_000_000, 1);
                }
            }
        }
